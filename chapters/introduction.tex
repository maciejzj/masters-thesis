...
Super-resolution is a technique relevant in satellite imaging,
...
The approach based on traditional resizing algorithms creates missing low-resolution pictures by downsizing the existing ones.
However, with deep learning a set of high and low-resolution images is used to train the augmentation model.
